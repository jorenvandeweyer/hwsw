...
module nios_mm_interconnect_0 (
	...
	wire  [93:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> uart_0_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // uart_0_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [7:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> uart_0_s1_agent:cp_channel
	...
	wire  [94:0] switches_s1_agent_rf_source_data;                                                   // switches_s1_agent:rf_source_data -> switches_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] switches_s1_agent_rsp_fifo_out_data;                                                // switches_s1_agent_rsp_fifo:out_data -> switches_s1_agent:rf_sink_data
	...
	wire  [93:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> switches_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                              // switches_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [7:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> switches_s1_agent:cp_channel
	...
	wire  [93:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> leds_s1_agent:cp_data
	...
	wire  [94:0] buttons_s1_agent_rf_source_data;                                                    // buttons_s1_agent:rf_source_data -> buttons_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] buttons_s1_agent_rsp_fifo_out_data;                                                 // buttons_s1_agent_rsp_fifo:out_data -> buttons_s1_agent:rf_sink_data
	...
	wire  [93:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> buttons_s1_agent:cp_data
	...
	wire  [93:0] uart_0_s1_agent_rp_data;                                                            // uart_0_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [93:0] switches_s1_agent_rp_data;                                                          // switches_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [93:0] leds_s1_agent_rp_data;                                                              // leds_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [93:0] buttons_s1_agent_rp_data;                                                           // buttons_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [93:0] router_src_data;                                                                    // router:src_data -> nios2_qsys_0_data_master_limiter:cmd_sink_data
	wire         router_src_ready;                                                                   // nios2_qsys_0_data_master_limiter:cmd_sink_ready -> router:src_ready
	wire   [7:0] router_src_channel;                                                                 // router:src_channel -> nios2_qsys_0_data_master_limiter:cmd_sink_channel
	...
	wire  [93:0] nios2_qsys_0_data_master_limiter_cmd_src_data;                                      // nios2_qsys_0_data_master_limiter:cmd_src_data -> cmd_demux:sink_data
	wire         nios2_qsys_0_data_master_limiter_cmd_src_ready;                                     // cmd_demux:sink_ready -> nios2_qsys_0_data_master_limiter:cmd_src_ready
	wire   [7:0] nios2_qsys_0_data_master_limiter_cmd_src_channel;                                   // nios2_qsys_0_data_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire  [93:0] rsp_mux_src_data;                                                                   // rsp_mux:src_data -> nios2_qsys_0_data_master_limiter:rsp_sink_data
	wire         rsp_mux_src_ready;                                                                  // nios2_qsys_0_data_master_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire   [7:0] rsp_mux_src_channel;                                                                // rsp_mux:src_channel -> nios2_qsys_0_data_master_limiter:rsp_sink_channel
	...
	wire  [93:0] nios2_qsys_0_data_master_limiter_rsp_src_data;                                      // nios2_qsys_0_data_master_limiter:rsp_src_data -> nios2_qsys_0_data_master_agent:rp_data
	...
	wire   [7:0] nios2_qsys_0_data_master_limiter_rsp_src_channel;                                   // nios2_qsys_0_data_master_limiter:rsp_src_channel -> nios2_qsys_0_data_master_agent:rp_channel
	...
	wire  [93:0] router_001_src_data;                                                                // router_001:src_data -> nios2_qsys_0_instruction_master_limiter:cmd_sink_data
	wire         router_001_src_ready;                                                               // nios2_qsys_0_instruction_master_limiter:cmd_sink_ready -> router_001:src_ready
	wire   [7:0] router_001_src_channel;                                                             // router_001:src_channel -> nios2_qsys_0_instruction_master_limiter:cmd_sink_channel
	...
	wire  [93:0] nios2_qsys_0_instruction_master_limiter_cmd_src_data;                               // nios2_qsys_0_instruction_master_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire   [7:0] nios2_qsys_0_instruction_master_limiter_cmd_src_channel;                            // nios2_qsys_0_instruction_master_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire  [93:0] rsp_mux_001_src_data;                                                               // rsp_mux_001:src_data -> nios2_qsys_0_instruction_master_limiter:rsp_sink_data
	wire         rsp_mux_001_src_ready;                                                              // nios2_qsys_0_instruction_master_limiter:rsp_sink_ready -> rsp_mux_001:src_ready
	wire   [7:0] rsp_mux_001_src_channel;                                                            // rsp_mux_001:src_channel -> nios2_qsys_0_instruction_master_limiter:rsp_sink_channel
	...
	wire  [93:0] nios2_qsys_0_instruction_master_limiter_rsp_src_data;                               // nios2_qsys_0_instruction_master_limiter:rsp_src_data -> nios2_qsys_0_instruction_master_agent:rp_data
	...
	wire   [7:0] nios2_qsys_0_instruction_master_limiter_rsp_src_channel;                            // nios2_qsys_0_instruction_master_limiter:rsp_src_channel -> nios2_qsys_0_instruction_master_agent:rp_channel
	...
	wire   [7:0] nios2_qsys_0_data_master_limiter_cmd_valid_data;                                    // nios2_qsys_0_data_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire   [7:0] nios2_qsys_0_instruction_master_limiter_cmd_valid_data;                             // nios2_qsys_0_instruction_master_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	...
	nios_mm_interconnect_0_cmd_mux_005 cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_mm_interconnect_0_rsp_demux_005 rsp_demux_006 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
